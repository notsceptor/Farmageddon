...
func _choose_random_enemy(enemy_array: Array, wave_size: int) -> Array:
	...
	while enemy_selected == false:
		...
		match random_chosen_enemy:
			...
			"Vulture":
				chosen_enemy_scene = preload("res://Scenes/Enemies/Vulture/vulture_container.tscn")
				chosen_enemy_size = preload("res://Scenes/Enemies/Vulture/vulture_model.tscn").instantiate().get_size()
			"Grub":
				chosen_enemy_scene = preload("res://Scenes/Enemies/Grub/grub_container.tscn")
				chosen_enemy_size = preload("res://Scenes/Enemies/Grub/grub_model.tscn").instantiate().get_size()
...
func _choose_random_boss_enemy_and_spawn(enemy_array: Array):
	...
	match boss_enemy_string_name:
		...
		"Vulture":
			boss_enemy_scene = preload("res://Scenes/Enemies/Vulture/vulture_container.tscn")
		"Grub":
			boss_enemy_scene = preload("res://Scenes/Enemies/Grub/grub_container.tscn")
